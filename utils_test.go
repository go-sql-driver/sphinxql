...
var testDSNs = []struct {
	...
	{"user:password@/dbname", "&{user:user passwd:password net:tcp addr:127.0.0.1:9306 dbname:dbname params:map[]}"},
	...
	{"/dbname", "&{user: passwd: net:tcp addr:127.0.0.1:9306 dbname:dbname params:map[]}"},
	{"/", "&{user: passwd: net:tcp addr:127.0.0.1:9306 dbname: params:map[]}"},
	{"user:p@/ssword@/", "&{user:user passwd:p@/ssword net:tcp addr:127.0.0.1:9306 dbname: params:map[]}"},
}
